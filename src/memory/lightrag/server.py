...
mcp = FastMCP(
    name="Rag memory",
    description="Memory for RAG (Retrieval-Augmented Generation) tasks",
    port=6001,
    host="localhost"
)
...
async def lightrag_new_tool(domain:str ,user_prompt:str|None = None,directory_selection:str=None, question:str=None, history:list=[]) -> dict:
    ...
    args:
    domain (str): Domain of the project (e.g., Project Management, HR, Insurance    
    directory_selection (str): Directory to select files from
